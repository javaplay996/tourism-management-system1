        ...
        <div v-else>
          <el-form-item v-if="ruleForm.touxiang" label="头像" prop="touxiang">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.touxiang.split(',')" :src="item" width="100" height="100">
                                                                                              ...
                                                                                              <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="个性签名" prop="gexingqianming">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="个性签名"
                  v-model="ruleForm.gexingqianming" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.gexingqianming" label="个性签名" prop="gexingqianming">
                    <span>{{ruleForm.gexingqianming}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.touxiang = true;
            continue;
	            	            ...
	            	            if(o=='gexingqianming'){
            this.ruleForm.gexingqianming = obj[o];
	    this.ro.gexingqianming = true;
            continue;
          }
	                    }
                                                                                                              }
